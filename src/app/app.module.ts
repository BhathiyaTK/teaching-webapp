...
import { ReadMoreLessComponent } from './dashboard/admin-manage-classes/admin-all-classes/read-more-less/read-more-less.component';
import { ApprovalReadMoreLessComponent } from './dashboard/admin-manage-classes/class-approvals/approval-read-more-less/approval-read-more-less.component';
import { TeacherShowMoreLessComponent } from './dashboard/admin-manage-teachers/all-teachers/teacher-show-more-less/teacher-show-more-less.component';
import { TchrAddClassComponent } from './dashboard/tchr-add-class/tchr-add-class.component';
...
@NgModule({
  declarations: [
    ...
    ApprovalReadMoreLessComponent,
    TeacherShowMoreLessComponent,
    TchrAddClassComponent
  ],
  imports: [
    BrowserModule,
    HttpClientModule,
